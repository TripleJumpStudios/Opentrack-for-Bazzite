**Update**
This project is now depreciated. Recommend using the Opentrack Appimage provided here. (Opentrack)[https://github.com/opentrack/opentrack]
Note that if attempting to use with Star Citizen there is a potential bug with the wrapper. More information can be found on the (Star Citizen Lug Knowledge Base)[https://wiki.starcitizen-lug.org/Head-Tracking]
